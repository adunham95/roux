  ...
  return (
    <InputWrapper {...props}>
      <select
        ...
        className={twMerge(
          'mt-2 block w-full rounded-md border-0 py-2 pl-3 pr-6 text-tc-1 bg-surface ring-1 ring-inset ring-surface-1 focus:ring-2 focus-brand-600 sm:text-sm sm:leading-6',
          hasError &&
