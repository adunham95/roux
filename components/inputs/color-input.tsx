  ...
  return (
    <InputWrapper {...props}>
      ...
      <input
        ...
        value={value}
        className={twMerge(
          'block w-full rounded-md border-0 mt-2 p-1.5 shadow-sm ring-1 ring-inset ring-surface-5 bg-surface placeholder:text-tc-3 text-tc-1 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6',
          hasError &&
