    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
          ...
          <section className="p-8 rounded-xl bg-gray-400/5 ring-1 ring-inset ring-gray-200">
            <h3
              id="tier-essential"
              className="text-sm font-semibold leading-6 text-gray-900"
            >
              ...
              <tbody>
                ...
                <tr>
                  <th
                    scope="colgroup"
                    colSpan={4}
                    className="pb-4 text-sm font-semibold leading-6 text-gray-900 pt-8"
                  >
                    Features
                ...
                <tr>
                  <th
                    scope="colgroup"
                    colSpan={4}
                    className="pb-4 text-sm font-semibold leading-6 text-gray-900 pt-16"
                  >
                    Reporting
                    <div className="absolute inset-x-8 mt-4 h-px bg-gray-900/10"></div>
                  </th>
